...
// in flutter_weather_app/test/features/weather/domain/usecases/get_weather_usecase_test.dart.
...
import 'package:flutter_weather_app/core/domain/repositories/weather_repository.dart' as _i6;
...
class MockWeatherRepository extends _i1.Mock implements _i6.WeatherRepository {
  ...
  @override
  Future<_i4.Either<_i7.Failure, _i5.Weather>> getCurrentWeather(String? cityName, String? lang) => (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeather,
          [cityName, lang],
        ),
